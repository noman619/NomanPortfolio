...
const Projects: React.FC = () => {
  const LOCAL_PROJECTS: Project[] = [
    {
      id: '1',
      title: 'Slide In Banner',
      category: 'Custom Section', // Added category
      description: 'Custom Shopify section Hero Banner.',
      image: '/SlideInBanner.gif',
    //   video: '/SlideInBanner.gif',
      link: '#',
      tags: ['Shopify', 'Liquid', 'HTML', 'CSS', 'JavaScript', 'Responsive', "Standalone Section"],
      isLive: true,
      stats: [
    ...
    {
      id: '2',
      title: 'Dual Screen Carousel',
      category: 'Custom Section', // Added category
      description: 'Custom Shopify Dual Screen Carousel section.',
      image: '/DualScreenCarousel.gif',
      link: '#',
      tags: ['Shopify', 'Liquid', 'HTML', 'CSS', 'JavaScript', 'Responsive', "Standalone Section", 'Carousel', 'Dual Screen'],
      isLive: true,
      stats: [
        { label: 'Fully Responsive', value: 'Works on all devices' },
        { label: 'Theme Compatibility', value: 'Compatible with all themes' },
      ],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Custom Sections</h2>
            <p className="text-gray-400 max-w-xl text-lg">
                Dynamic interactive, mobile-optimized Shopify Liquid sections that enhance storefront UX using Liquid, HTML, CSS, and JavaScript.
            </p>
          </div>
        </motion.div>
